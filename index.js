...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooArray){
    ...
    let displayNames = [];
    zooArray.forEach(function(zooArray, ind){
      displayNames.push(`name: ${zooArray.animal_name}, scientific: ${zooArray.scientific_name}`);
    })
   return displayNames;
  }
  ...
  */
  ...
  function lowerCaseNames(zooArray){
   return zooArray.map(function(array,ind){
